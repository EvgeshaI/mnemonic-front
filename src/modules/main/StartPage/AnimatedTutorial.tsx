...
import Slide1Black from '../../../import/images/slide1Blak.png'
import Slide2 from '../../../import/images/slide2.png'
import Slide2Black from '../../../import/images/slide2Black.png'
import Slide3 from '../../../import/images/slide3.png'
import Slide3Black from '../../../import/images/slide3Black.png'
import Slide4 from '../../../import/images/slide4.png'
import Slide4Black from '../../../import/images/slide4Black.png'
import Slide5 from '../../../import/images/slide5.png'
import Slide5Black from '../../../import/images/slide5Black.png'
import s from './startPage.module.scss'

type AnimatedTutorialPropsType = {
    isDarkTheme: boolean
}

export const AnimatedTutorial: FC<AnimatedTutorialPropsType> = (props) => {
    return (
        <div className={s.animatedTutorialBox}>
            <div className={s.firstSlideBox}>
                <AnimationOnScroll animateIn="animate__backInLeft" animateOnce={true}>
                    <div className={s.slade1Image}>
                        {props.isDarkTheme ? <img src={Slide1Black}/> : <img src={Slide1}/>}
                    </div>
            ...
            <div className={s.secondSlideBox}>
                <div className={s.secondSlideImage}>
                    <AnimationOnScroll animateIn="animate__backInLeft" animateOnce={true}>
                        <div className={s.sladeImage}>
                            {props.isDarkTheme ? <img src={Slide2Black}/> : <img src={Slide2}/> }
                        </div>
                    </AnimationOnScroll>
                </div>
            ...
            <div  className={s.thirdSlideBox}>
                ...
                <div className={s.thirdSlideImage}>
                    <AnimationOnScroll animateIn="animate__backInRight" animateOnce={true}>
                        <div className={s.sladeImage}>
                            {props.isDarkTheme ? <img src={Slide3Black}/> : <img src={Slide3}/>}
                        </div>
                    </AnimationOnScroll>
                </div>
            ...
            <div className={s.fourthSlideBox}>
                <div className={s.fourthSlideImage}>
                    <AnimationOnScroll animateIn="animate__backInLeft" animateOnce={true}>
                        <div className={s.sladeImage}>
                            {props.isDarkTheme ? <img src={Slide4Black}/> : <img src={Slide4}/>}
                        </div>
                    </AnimationOnScroll>
                </div>
            ...
            <div className={s.fifthSlideBox}>
                ...
                <div className={s.fifthSlideImage}>
                    <AnimationOnScroll animateIn="animate__backInUp" animateOnce={true}>
                        <div className={s.sladeImage}>
                            {props.isDarkTheme ? <img src={Slide5Black}/> : <img src={Slide5}/>}
                        </div>
                    </AnimationOnScroll>
                </div>
            </div>
